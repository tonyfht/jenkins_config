...
<td class="hits"/>
<td class="code">&nbsp;*&nbsp;Chequeos&nbsp;que&nbsp;se&nbsp;aplican&nbsp;para&nbsp;ver&nbsp;la&nbsp;existencia&nbsp;de&nbsp;ficheros.</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">public&nbsp;class&nbsp;ChequeoExistenciaFicheros&nbsp;extends&nbsp;AbstractChequeo{</td>
</tr>
<tr class="noCover">
...
<td class="hits">68364</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;private&nbsp;Collection&lt;ReglaArchivo&gt;&nbsp;reglasFichObligatNoEncontrados&nbsp;=&nbsp;new&nbsp;HashSet&lt;ReglaArchivo&gt;();</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;ChequeoExistenciaFicheros(String&nbsp;nombre,&nbsp;String&nbsp;descripcion,String&nbsp;mensajeIncorrecto,&nbsp;String&nbsp;mensajeCorrecto,&nbsp;String&nbsp;mensajeAviso)&nbsp;{</td>
</tr>
<tr class="coverFull">
...
<td class="hits">1463454</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;super.agregarRegla(regla);</td>
</tr>
<tr class="coverFull">
<td class="line"><a name='40'/>40</td>
<td class="hits">1463454</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ReglaArchivo&nbsp;reglaArchivo&nbsp;=&nbsp;(ReglaArchivo)regla;</td>
</tr>
<tr class="coverFull">
<td class="line"><a name='41'/>41</td>
<td class="hits">1463454</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(reglaArchivo.getTipoComprobacion()&nbsp;==&nbsp;TipoComprobacion.OBLIGATORIEDAD){</td>
</tr>
<tr class="coverFull">
<td class="line"><a name='42'/>42</td>
<td class="hits">40554</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reglasFichObligatNoEncontrados.add(reglaArchivo);</td>
</tr>
<tr class="noCover">
...
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;(IRegla&nbsp;regla&nbsp;:&nbsp;reglasFichObligatNoEncontrados)&nbsp;{</td>
</tr>
<tr class="coverFull">
...
<tr class="coverPart" title="Line 51: Conditional coverage 50% (1/2)">
<td class="line"><a name='51'/>51</td>
<td class="hits">738</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NivelIncidencia&nbsp;nivelIncidencia&nbsp;=&nbsp;reglaArchivo.getTipoComprobacion()&nbsp;==&nbsp;TipoComprobacion.EXISTENCIA?NivelIncidencia.ADVERTENCIA:NivelIncidencia.ERROR;</td>
</tr>
<tr class="coverFull">
<td class="line"><a name='52'/>52</td>
<td class="hits">738</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;registraIncidenciaChequeo(nivelIncidencia,&nbsp;reglaArchivo.getEjemplo(),&nbsp;"&nbsp;");</td>
</tr>
<tr class="coverFull">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;@param&nbsp;fichero&nbsp;el&nbsp;fichero&nbsp;sobre&nbsp;el&nbsp;que&nbsp;aplicar&nbsp;la&nbsp;regla.</td>
</tr>
<tr class="noCover">
...
<td class="hits">6336</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TipoComprobacion&nbsp;tipoComprobacionArchivo&nbsp;=&nbsp;reglaArchivo.getTipoComprobacion();</td>
</tr>
<tr class="noCover">
...
<td class="hits">6354</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;switch&nbsp;(tipoComprobacionArchivo)&nbsp;{</td>
</tr>
<tr class="noCover">
...
<td class="hits">2520</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;registraIncidenciaChequeo(IncidenciaChequeo.NivelIncidencia.ERROR,&nbsp;fichero.rutaRelativa(),&nbsp;"&nbsp;"&nbsp;+&nbsp;reglaArchivo.getEjemplo());</td>
</tr>
<tr class="coverFull">
...
<td class="hits">36</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;registraIncidenciaChequeo(IncidenciaChequeo.NivelIncidencia.ADVERTENCIA,&nbsp;fichero.rutaRelativa(),&nbsp;"&nbsp;"&nbsp;+&nbsp;reglaArchivo.getEjemplo());</td>
</tr>
<tr class="coverFull">
...
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;marcarFicheroObligatorioEncontrado(regla);</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;private&nbsp;void&nbsp;marcarFicheroObligatorioEncontrado(IRegla&nbsp;regla)&nbsp;{</td>
</tr>
<tr class="coverFull">
...
<td class="hits">3780</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reglasFichObligatNoEncontrados.remove(reglaArchivo);</td>
</tr>
<tr class="coverFull">
