...
<td class="hits"/>
<td class="code">&nbsp;*&nbsp;&lt;p&gt;Java&nbsp;class&nbsp;for&nbsp;TipoReglas&nbsp;complex&nbsp;type.</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;*&nbsp;&amp;lt;complexType&nbsp;name="TipoReglas"&gt;</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&amp;lt;element&nbsp;name="regla"&nbsp;type="{http://www.iam.es/repositorio}TipoRegla"&nbsp;maxOccurs="unbounded"&nbsp;minOccurs="0"/&gt;</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">@XmlType(name&nbsp;=&nbsp;"TipoReglas",&nbsp;propOrder&nbsp;=&nbsp;{</td>
</tr>
<tr class="noCover">
<td class="line"><a name='39'/>39</td>
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;"regla"</td>
</tr>
<tr class="noCover">
...
<td class="code">public&nbsp;class&nbsp;TipoReglas&nbsp;{</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;protected&nbsp;List&lt;TipoRegla&gt;&nbsp;regla;</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;Gets&nbsp;the&nbsp;value&nbsp;of&nbsp;the&nbsp;regla&nbsp;property.</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;This&nbsp;is&nbsp;why&nbsp;there&nbsp;is&nbsp;not&nbsp;a&nbsp;&lt;CODE&gt;set&lt;/CODE&gt;&nbsp;method&nbsp;for&nbsp;the&nbsp;regla&nbsp;property.</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;getRegla().add(newItem);</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;{@link&nbsp;TipoRegla&nbsp;}</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;List&lt;TipoRegla&gt;&nbsp;getRegla()&nbsp;{</td>
</tr>
<tr class="coverPart" title="Line 68: Conditional coverage 50% (1/2)">
<td class="line"><a name='68'/>68</td>
<td class="hits">84834</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(regla&nbsp;==&nbsp;null)&nbsp;{</td>
</tr>
<tr class="coverNone">
<td class="line"><a name='69'/>69</td>
<td class="hits">0</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;regla&nbsp;=&nbsp;new&nbsp;ArrayList&lt;TipoRegla&gt;();</td>
</tr>
<tr class="noCover">
...
<td class="hits">84834</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;this.regla;</td>
</tr>
<tr class="noCover">
