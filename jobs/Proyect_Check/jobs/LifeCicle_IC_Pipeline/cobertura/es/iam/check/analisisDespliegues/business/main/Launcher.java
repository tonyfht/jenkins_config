...
<td class="hits">0</td>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Uso.mostrar("La&nbsp;instalación&nbsp;de&nbsp;la&nbsp;aplicación&nbsp;no&nbsp;es&nbsp;correcta.&nbsp;Revisarla:"&nbsp;+&nbsp;instExc);</td>
</tr>
<tr class="coverFull">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;@return&nbsp;el&nbsp;objeto&nbsp;Configuracion&nbsp;que&nbsp;representa&nbsp;las&nbsp;opciones&nbsp;de&nbsp;ejecución&nbsp;del&nbsp;programa.</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;@param&nbsp;configuracion&nbsp;el&nbsp;objeto&nbsp;Configuracion&nbsp;que&nbsp;representa&nbsp;las&nbsp;opciones&nbsp;de&nbsp;ejecución&nbsp;del&nbsp;programa.</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//de&nbsp;la&nbsp;aplicación&nbsp;y&nbsp;recolocar&nbsp;algunas&nbsp;responsabilidades&nbsp;que</td>
</tr>
<tr class="noCover">
<td class="line"><a name='62'/>62</td>
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//tenia&nbsp;la&nbsp;clase&nbsp;de&nbsp;configuración&nbsp;y&nbsp;que&nbsp;no&nbsp;lo&nbsp;pertenecian.&nbsp;Se&nbsp;ha&nbsp;hecho&nbsp;en&nbsp;parte...</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;Trasnforma&nbsp;la&nbsp;linea&nbsp;de&nbsp;comandos&nbsp;en&nbsp;un&nbsp;mapa&nbsp;con&nbsp;semántica&nbsp;interna&nbsp;representando&nbsp;lo</td>
</tr>
<tr class="noCover">
<td class="line"><a name='69'/>69</td>
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;que&nbsp;se&nbsp;desea&nbsp;ejecutar&nbsp;en&nbsp;el&nbsp;análisis.</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;Método&nbsp;que&nbsp;devuelve&nbsp;un&nbsp;fichero&nbsp;a&nbsp;analizar&nbsp;en&nbsp;base&nbsp;a&nbsp;las&nbsp;opciones&nbsp;de&nbsp;configuracion</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;al&nbsp;mismo&nbsp;y&nbsp;un&nbsp;filtro&nbsp;para&nbsp;que&nbsp;solo&nbsp;se&nbsp;muestre&nbsp;en&nbsp;el&nbsp;informe&nbsp;de&nbsp;análisis&nbsp;los&nbsp;chequeos&nbsp;que</td>
</tr>
<tr class="noCover">
<td class="line"><a name='88'/>88</td>
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;se&nbsp;deseen.&nbsp;TODO:&nbsp;Esta&nbsp;responsabilidad&nbsp;era&nbsp;parte&nbsp;de&nbsp;la&nbsp;configuración&nbsp;(en&nbsp;forma&nbsp;inadecuada)&nbsp;</td>
</tr>
<tr class="noCover">
<td class="line"><a name='89'/>89</td>
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;por&nbsp;lo&nbsp;que&nbsp;se&nbsp;ha&nbsp;extraido&nbsp;a&nbsp;esta&nbsp;clase&nbsp;como&nbsp;primer&nbsp;paso&nbsp;de&nbsp;una&nbsp;refactorización&nbsp;más&nbsp;profunda&nbsp;que&nbsp;está</td>
</tr>
<tr class="noCover">
...
<td class="hits"/>
<td class="code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;@param&nbsp;conf&nbsp;el&nbsp;objeto&nbsp;Configuracion&nbsp;que&nbsp;representa&nbsp;las&nbsp;opciones&nbsp;de&nbsp;ejecución&nbsp;del&nbsp;programa.</td>
</tr>
<tr class="noCover">
